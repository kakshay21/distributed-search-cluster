...
// source: src/main/java/model/proto/search_cluster_query.proto
...
public final class SearchModel {
  ...
  public interface ResponseOrBuilder extends
    ...
    /**
     * <code>repeated .distributed.search.Response.DocumentStats relevant_document = 1;</code>
     */
    java.util.List<model.proto.SearchModel.Response.DocumentStats> 
        getRelevantDocumentList();
    /**
     * <code>repeated .distributed.search.Response.DocumentStats relevant_document = 1;</code>
     */
    model.proto.SearchModel.Response.DocumentStats getRelevantDocument(int index);
    /**
     * <code>repeated .distributed.search.Response.DocumentStats relevant_document = 1;</code>
     */
    int getRelevantDocumentCount();
    /**
     * <code>repeated .distributed.search.Response.DocumentStats relevant_document = 1;</code>
     */
    java.util.List<? extends model.proto.SearchModel.Response.DocumentStatsOrBuilder> 
        getRelevantDocumentOrBuilderList();
    /**
     * <code>repeated .distributed.search.Response.DocumentStats relevant_document = 1;</code>
     */
    model.proto.SearchModel.Response.DocumentStatsOrBuilder getRelevantDocumentOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    private Response() {
      relevantDocument_ = java.util.Collections.emptyList();
    }
    ...
    private Response(
      ...
      try {
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                relevantDocument_ = new java.util.ArrayList<model.proto.SearchModel.Response.DocumentStats>();
                mutable_bitField0_ |= 0x00000001;
              }
              relevantDocument_.add(
        ...
        if (((mutable_bitField0_ & 0x00000001) != 0)) {
          relevantDocument_ = java.util.Collections.unmodifiableList(relevantDocument_);
        }
        this.unknownFields = unknownFields.build();
        makeExtensionsImmutable();
      }
  ...
  bitField0_ |= 0x00000001;
    ...
    public static final int RELEVANT_DOCUMENT_FIELD_NUMBER = 1;
    private java.util.List<model.proto.SearchModel.Response.DocumentStats> relevantDocument_;
    /**
     * <code>repeated .distributed.search.Response.DocumentStats relevant_document = 1;</code>
     */
    @java.lang.Override
    public java.util.List<model.proto.SearchModel.Response.DocumentStats> getRelevantDocumentList() {
      return relevantDocument_;
    }
    /**
     * <code>repeated .distributed.search.Response.DocumentStats relevant_document = 1;</code>
     */
     ...
     */
    @java.lang.Override
    public int getRelevantDocumentCount() {
      return relevantDocument_.size();
    }
    /**
     * <code>repeated .distributed.search.Response.DocumentStats relevant_document = 1;</code>
     */
    @java.lang.Override
    public model.proto.SearchModel.Response.DocumentStats getRelevantDocument(int index) {
      return relevantDocument_.get(index);
    }
    /**
     * <code>repeated .distributed.search.Response.DocumentStats relevant_document = 1;</code>
     */
    @java.lang.Override
    public model.proto.SearchModel.Response.DocumentStatsOrBuilder getRelevantDocumentOrBuilder(
        int index) {
      return relevantDocument_.get(index);
    }
    ...
    public final boolean isInitialized() {
      ...
      for (int i = 0; i < getRelevantDocumentCount(); i++) {
        if (!getRelevantDocument(i).isInitialized()) {
          memoizedIsInitialized = 0;
          return false;
        }
      }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
                        throws java.io.IOException {
      for (int i = 0; i < relevantDocument_.size(); i++) {
        output.writeMessage(1, relevantDocument_.get(i));
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < relevantDocument_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, relevantDocument_.get(i));
      }
      size += unknownFields.getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getRelevantDocumentList()
          .equals(other.getRelevantDocumentList())) return false;
      if (!unknownFields.equals(other.unknownFields)) return false;
      return true;
    }
    ...
    public int hashCode() {
      ...
      int hash = 41;
      hash = (19 * hash) + getDescriptor().hashCode();
      if (getRelevantDocumentCount() > 0) {
        hash = (37 * hash) + RELEVANT_DOCUMENT_FIELD_NUMBER;
        hash = (53 * hash) + getRelevantDocumentList().hashCode();
      }
      hash = (29 * hash) + unknownFields.hashCode();
      memoizedHashCode = hash;
      return hash;
    ...
    public static final class Builder extends
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessageV3
                .alwaysUseFieldBuilders) {
          getRelevantDocumentFieldBuilder();
        }
      }
      @java.lang.Override
      public Builder clear() {
        super.clear();
        if (relevantDocumentBuilder_ == null) {
          relevantDocument_ = java.util.Collections.emptyList();
          bitField0_ = (bitField0_ & ~0x00000001);
        } else {
          relevantDocumentBuilder_.clear();
        }
        return this;
      }
      ...
      public model.proto.SearchModel.Response buildPartial() {
        ...
        if (relevantDocumentBuilder_ == null) {
          ...
          result.relevantDocument_ = relevantDocument_;
        } else {
          result.relevantDocument_ = relevantDocumentBuilder_.build();
        }
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(model.proto.SearchModel.Response other) {
        ...
        if (relevantDocumentBuilder_ == null) {
          if (!other.relevantDocument_.isEmpty()) {
            if (relevantDocument_.isEmpty()) {
              relevantDocument_ = other.relevantDocument_;
              bitField0_ = (bitField0_ & ~0x00000001);
            } else {
              ensureRelevantDocumentIsMutable();
              relevantDocument_.addAll(other.relevantDocument_);
            }
            onChanged();
          }
        } else {
          if (!other.relevantDocument_.isEmpty()) {
            if (relevantDocumentBuilder_.isEmpty()) {
              relevantDocumentBuilder_.dispose();
              relevantDocumentBuilder_ = null;
              relevantDocument_ = other.relevantDocument_;
              bitField0_ = (bitField0_ & ~0x00000001);
              relevantDocumentBuilder_ = 
                com.google.protobuf.GeneratedMessageV3.alwaysUseFieldBuilders ?
                   getRelevantDocumentFieldBuilder() : null;
            } else {
              relevantDocumentBuilder_.addAllMessages(other.relevantDocument_);
            }
          }
        }
        this.mergeUnknownFields(other.unknownFields);
      ...
      private void ensureRelevantDocumentIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          relevantDocument_ = new java.util.ArrayList<model.proto.SearchModel.Response.DocumentStats>(relevantDocument_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          model.proto.SearchModel.Response.DocumentStats, model.proto.SearchModel.Response.DocumentStats.Builder, model.proto.SearchModel.Response.DocumentStatsOrBuilder> relevantDocumentBuilder_;
      ...
      public java.util.List<model.proto.SearchModel.Response.DocumentStats> getRelevantDocumentList() {
        if (relevantDocumentBuilder_ == null) {
          return java.util.Collections.unmodifiableList(relevantDocument_);
        } else {
          return relevantDocumentBuilder_.getMessageList();
        }
      }
      /**
       * <code>repeated .distributed.search.Response.DocumentStats relevant_document = 1;</code>
      ...
      public int getRelevantDocumentCount() {
        if (relevantDocumentBuilder_ == null) {
          ...
          return relevantDocumentBuilder_.getCount();
        }
      }
      /**
       * <code>repeated .distributed.search.Response.DocumentStats relevant_document = 1;</code>
      ...
      public model.proto.SearchModel.Response.DocumentStats getRelevantDocument(int index) {
        if (relevantDocumentBuilder_ == null) {
          ...
          return relevantDocumentBuilder_.getMessage(index);
        }
      }
      /**
       * <code>repeated .distributed.search.Response.DocumentStats relevant_document = 1;</code>
       */
      public Builder setRelevantDocument(
        ...
        if (relevantDocumentBuilder_ == null) {
          ...
          ensureRelevantDocumentIsMutable();
          relevantDocument_.set(index, value);
          onChanged();
        } else {
          relevantDocumentBuilder_.setMessage(index, value);
        }
        return this;
      }
      /**
      ...
      public Builder setRelevantDocument(
        ...
        if (relevantDocumentBuilder_ == null) {
          ensureRelevantDocumentIsMutable();
          relevantDocument_.set(index, builderForValue.build());
          onChanged();
        } else {
          relevantDocumentBuilder_.setMessage(index, builderForValue.build());
        }
        return this;
      }
      /**
       * <code>repeated .distributed.search.Response.DocumentStats relevant_document = 1;</code>
       */
      public Builder addRelevantDocument(model.proto.SearchModel.Response.DocumentStats value) {
        if (relevantDocumentBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
          ensureRelevantDocumentIsMutable();
          relevantDocument_.add(value);
          onChanged();
        } else {
          relevantDocumentBuilder_.addMessage(value);
        }
        return this;
      }
      /**
       * <code>repeated .distributed.search.Response.DocumentStats relevant_document = 1;</code>
       */
      public Builder addRelevantDocument(
          int index, model.proto.SearchModel.Response.DocumentStats value) {
        if (relevantDocumentBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          ...
          ensureRelevantDocumentIsMutable();
          relevantDocument_.add(index, value);
          onChanged();
        } else {
          relevantDocumentBuilder_.addMessage(index, value);
        }
        return this;
      }
      /**
      ...
      public Builder addRelevantDocument(
        ...
        if (relevantDocumentBuilder_ == null) {
          ensureRelevantDocumentIsMutable();
          relevantDocument_.add(builderForValue.build());
          onChanged();
        } else {
          relevantDocumentBuilder_.addMessage(builderForValue.build());
        }
        return this;
      }
      /**
      ...
      public Builder addRelevantDocument(
        ...
        if (relevantDocumentBuilder_ == null) {
          ensureRelevantDocumentIsMutable();
          relevantDocument_.add(index, builderForValue.build());
          onChanged();
        } else {
          relevantDocumentBuilder_.addMessage(index, builderForValue.build());
        }
        return this;
      }
      /**
       * <code>repeated .distributed.search.Response.DocumentStats relevant_document = 1;</code>
       */
      public Builder addAllRelevantDocument(
          java.lang.Iterable<? extends model.proto.SearchModel.Response.DocumentStats> values) {
        if (relevantDocumentBuilder_ == null) {
          ensureRelevantDocumentIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, relevantDocument_);
          onChanged();
        } else {
          relevantDocumentBuilder_.addAllMessages(values);
        }
        return this;
      }
      /**
       * <code>repeated .distributed.search.Response.DocumentStats relevant_document = 1;</code>
       */
      public Builder clearRelevantDocument() {
        if (relevantDocumentBuilder_ == null) {
          relevantDocument_ = java.util.Collections.emptyList();
          bitField0_ = (bitField0_ & ~0x00000001);
          onChanged();
       ...
       * <code>repeated .distributed.search.Response.DocumentStats relevant_document = 1;</code>
       */
      public Builder removeRelevantDocument(int index) {
        if (relevantDocumentBuilder_ == null) {
          ensureRelevantDocumentIsMutable();
          relevantDocument_.remove(index);
          onChanged();
        } else {
          relevantDocumentBuilder_.remove(index);
        }
        return this;
      }
      /**
       * <code>repeated .distributed.search.Response.DocumentStats relevant_document = 1;</code>
       */
      public model.proto.SearchModel.Response.DocumentStats.Builder getRelevantDocumentBuilder(
          int index) {
        return getRelevantDocumentFieldBuilder().getBuilder(index);
      }
      /**
       * <code>repeated .distributed.search.Response.DocumentStats relevant_document = 1;</code>
       */
      public model.proto.SearchModel.Response.DocumentStatsOrBuilder getRelevantDocumentOrBuilder(
          int index) {
        if (relevantDocumentBuilder_ == null) {
          return relevantDocument_.get(index);  } else {
          return relevantDocumentBuilder_.getMessageOrBuilder(index);
        }
      }
      /**
       * <code>repeated .distributed.search.Response.DocumentStats relevant_document = 1;</code>
      ...
      public java.util.List<? extends model.proto.SearchModel.Response.DocumentStatsOrBuilder> 
           getRelevantDocumentOrBuilderList() {
        if (relevantDocumentBuilder_ != null) {
          return relevantDocumentBuilder_.getMessageOrBuilderList();
        } else {
          return java.util.Collections.unmodifiableList(relevantDocument_);
        }
      }
       ...
       * <code>repeated .distributed.search.Response.DocumentStats relevant_document = 1;</code>
       */
      public model.proto.SearchModel.Response.DocumentStats.Builder addRelevantDocumentBuilder() {
        return getRelevantDocumentFieldBuilder().addBuilder(
      ...
      public java.util.List<model.proto.SearchModel.Response.DocumentStats.Builder> 
           getRelevantDocumentBuilderList() {
        return getRelevantDocumentFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          ...
          getRelevantDocumentFieldBuilder() {
        if (relevantDocumentBuilder_ == null) {
          relevantDocumentBuilder_ = new com.google.protobuf.RepeatedFieldBuilderV3<
              model.proto.SearchModel.Response.DocumentStats, model.proto.SearchModel.Response.DocumentStats.Builder, model.proto.SearchModel.Response.DocumentStatsOrBuilder>(
                  relevantDocument_,
                  ((bitField0_ & 0x00000001) != 0),
                  getParentForChildren(),
                  isClean());
          relevantDocument_ = null;
        }
        return relevantDocumentBuilder_;
      }
      @java.lang.Override
      public final Builder setUnknownFields(
          final com.google.protobuf.UnknownFieldSet unknownFields) {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n4src/main/java/model/proto/search_clust" +
      "er_query.proto\022\022distributed.search\"\037\n\007Re" +
      "quest\022\024\n\014search_query\030\001 \002(\t\"\237\001\n\010Response" +
      "\022E\n\021relevant_document\030\001 \003(\0132*.distribute" +
      "d.search.Response.DocumentStats\032L\n\rDocum" +
    ...
    internal_static_distributed_search_Response_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_distributed_search_Response_descriptor,
        new java.lang.String[] { "RelevantDocument", });
    internal_static_distributed_search_Response_DocumentStats_descriptor =
